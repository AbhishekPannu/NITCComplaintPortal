...
public class user_complaint_model_class {
    private String building,roomNumber,complaintCategory,complaintDescription,rating,status,complaintID;
...
//    }
    ...
    public user_complaint_model_class() {
    }
}
